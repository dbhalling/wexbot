namespace :wextradelow do
  ...
  task rails: :environment do
    ...
    unit = TradeDatumLow.last.units
    crypto = TradeDatumLow.last.crypto
    target = TradeDatumLow.last.target
