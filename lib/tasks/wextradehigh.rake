namespace :wextradehigh do
  ...
  task rails: :environment do
    ...
    unit = TradeDatumHigh.last.units
    crypto = TradeDatumHigh.last.crypto
    target = TradeDatumHigh.last.target
    ...
    #while true
      ...
      TradeDatumHigh.where("created_at < ?", (Time.now - 4.days)).destroy_all
      #sleep(1.minutes)
    #end      
